...
<template>
  <div class="app-container" v-loading="loading">
      ...
      <el-main>
        ...
        >
          ...
          <el-col :span="12">
            ...
            <el-form-item :label="$t('trainEventInfo.speaker')" prop="speaker">
              <!-- <span
                ...
                >{{ spk.name }}</span
              > -->
              <span>{{formData.speaker ? formData.speaker.name : ''}}</span>
            </el-form-item>
            </el-col>
            <el-col :span="10">
          ...
          <el-col :span="12" v-if="choosedEnrollType == 'XXTJ'">
              <el-form-item :label="$t('municipalEventCreation.schoolRecommendNumber')">
                <el-button
                  type="primary"
                  size="small"
    ...
    />
    <school-recommend-dialog :visible.sync="schoolRecommendDialogVisible" :organizations="formData.organizations_details" @organizations="schoolRecommendDialogChange" :isView="true"/>
    <resource-pushing :visible.sync="resourcePushingDialogVisible" :resources="formData.resources" :isView="true" />
...
export default {
  ...
  data() {
    return {
      ...
      formData: {plan: {}, train_person: {}, course_type: {}, train_type: {}, organize_type: {}, enroll_type: {},organizations: [], gg_teachers: [], status: ''},
      editId: 0,
      choosedEnrollType: "",
      groupSelection: [],
      teacherleSelection: [],
  ...
  computed: {
    statusName(){
      let status = this.status_Operations.find(item => item.code == this.formData.status)
