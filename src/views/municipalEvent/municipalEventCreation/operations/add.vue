...
<template>
  <div class="app-container" v-loading="loading">
    ...
    />
    <school-recommend-dialog :visible.sync="schoolRecommendDialogVisible" :organizations="formData.organizations" @organizations="schoolRecommendDialogChange"/>
    
    <resource-pushing :visible.sync="resourcePushingDialogVisible" @attachments="getAttachmentListDialogChange"/>
  </div>
</template>
...
export default {
  ...
  computed: {
    getRules(){
      if(this.choosedEnrollType == 'ZJZD'){
  ...
  methods: {
    init() {
      Promise.all([
        ...
        getDataDictItemList({ type_code: "AREA_ZZFS" }),
    ...
    handelSpeakerChange(val){
      ...
      getSpeakers({speaker: val}, {limit: this.speaker_code === 'GGJS' ? 10 : 10000}).then(res => {
