...
import { getAnnualTrainPlanTypeInfoList, createAnnualTrainPlanInfo, annualTrainPlanSubmitCheck, getAnnualTrainPlanYearList } from '@/api/traineventmanage/annualTrainPlanInfo'
