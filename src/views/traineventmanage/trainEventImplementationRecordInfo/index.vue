<!--/*
 * @Name: trainEventImplementationRecordInfo
 * @Module:  src/views/traineventmanage/trainEventImplementationRecordInfo/index
 * @Desc: trainEventImplementationRecordInfo
...
export default {
  ...
  beforeRouteEnter(to, from, next) {
    if (!(~from.path.indexOf('trainEventImplementationRecordInfo'))) {
  ...
  beforeRouteLeave(to, from, next) {
    if (~to.path.indexOf('trainEventImplementationRecordInfo')) {
  ...
  methods: {
    ...
    handleAddRecordsClick(row) {
      this.$router.push({ path: '/school/trainEventImplementationRecordInfo/add', query: { pId: row.id }})
    },
    exportBtnClick(item) {
    ...
    handleCheckRecordsClick(row) {
      this.$router.push({ path: '/school/trainEventImplementationRecordInfo/checkImplementationRecord', query: { pId: row.id }})
    },
