...
<script>
import { getTrainEventTeacherInfo } from '@/api/municipalEvent/municipalEventCheckRegistration'
...
export default {
  ...
  methods: {
    ...
    getListData(activeStatus) {
      ...
      let getData =
        activeStatus === "waitCheck"
          ? { status: false,train_event__id: 13, ...this.apiQueryData, ...this.search }
          : { status: true,train_event__id: 13, ...this.apiQueryCheckedData, ...this.search };
