<!--/*
 * @Name: TrainEventClassHourDetailInfo
 * @Module:  src/views/traineventmanage/trainEventClassHourDetailInfo/index
 * @Desc: TrainEventClassHourDetailInfo
...
<template>
  <div class='app-container'>
      ...
      >
        ...
        >           <el-col :span='8'>
               <el-form-item
                   :label="$t('trainEventClassHourDetailInfo.class_hour')"
                   prop='class_hour'
               >
                   <el-select
                       v-model='exactSearchData.class_hour__name.type'
                   ...
                   >
                    <el-option
                        ...
                        :key="item.value"
                        :label="item.label"
                        :value="'class_hour__name'+item.value"
                    >
                    </el-option>
                   </el-select>
                   <el-input
                      v-show="exactSearchData.class_hour__name.type !='class_hour__name__isnull' && exactSearchData.class_hour__name.type !='class_hour__name__notnull'"
                      v-model='exactSearchData.class_hour__name.value'
           ...
           <el-col :span='8'>
               <el-form-item
                   :label="$t('trainEventClassHourDetailInfo.attachment')"
                   prop='attachment'
               >
                   <el-select
                       v-model='exactSearchData.attachment__name.type'
                       :placeholder="$t('common.select')"
                       class='exactSearchSelect'
                       popper-class='exactSearchSelectZIndex'
                   >
                    <el-option
                        ...
                        :key="item.value"
                        :label="item.label"
                        :value="'attachment__name'+item.value"
                    >
                    </el-option>
                   </el-select>
                   <el-input
                      v-show="exactSearchData.attachment__name.type !='attachment__name__isnull' && exactSearchData.attachment__name.type !='attachment__name__notnull'"
                      v-model='exactSearchData.attachment__name.value'
                      class='exactSearchInput'
                      type='text'
                   ></el-input>
               </el-form-item>
           ...
           <el-col :span='8'>
               <el-form-item
                   :label="$t('trainEventClassHourDetailInfo.attachment_explain')"
                   prop='attachment_explain'
               >
                   <el-select
                       v-model='exactSearchData.attachment_explain.type'
                       :placeholder="$t('common.select')"
                       class='exactSearchSelect'
                       popper-class='exactSearchSelectZIndex'
                   >
                    <el-option
                        ...
                        :key="item.value"
                        :label="item.label"
                        :value="'attachment_explain'+item.value"
                    >
                    </el-option>
                   </el-select>
                   <el-input
                      v-show="exactSearchData.attachment_explain.type !='attachment_explain__isnull' && exactSearchData.attachment_explain.type !='attachment_explain__notnull'"
                      v-model='exactSearchData.attachment_explain.value'
                      class='exactSearchInput'
                      type='text'
                   ></el-input>
               </el-form-item>
           ...
           <el-col :span='8'>
               <el-form-item
                   :label="$t('trainEventClassHourDetailInfo.remark')"
                   prop='remark'
               >
                   <el-select
      ...
      >
          ...
          <el-table-column
              ...
              :key='index'
              :prop='item'
              :label="$t(`trainEventClassHourDetailInfo.${item}`)"
           >
              <template slot-scope='scope'>
...
<script>
import { getTrainEventClassHourDetailInfoList, deleteTrainEventClassHourDetailInfo, exportTrainEventClassHourDetailInfo } from '@/api/traineventmanage/trainEventClassHourDetailInfo'
...
export default {
  ...
  data(){
      return{
          ...
          listColumns:['class_hour','attachment','attachment_explain','remark'], //表中显示的列
          ...
          exactSearchData:{ //精确查找的model
              class_hour__name:{value:'',type:'',value_range:''},
              attachment__name:{value:'',type:'',value_range:''},
              attachment_explain:{value:'',type:'',value_range:''},
  ...
  methods: {
      ...
      getListData() {
          ...
          getTrainEventClassHourDetailInfoList(this.apiQueryData
      ...
      handleDeleteClick(row) {
          ...
          if (this.deleteRoute !=  {}) {
              ...
              .then(async () => {
                  deleteTrainEventClassHourDetailInfo(row.id).then(response => {
      ...
      exportBtnClick(item) {
          ...
          exportTrainEventClassHourDetailInfo(exportData).then(response=>{
              fileDownload(response,`${this.$t('route.trainEventClassHourDetailInfo')}.xls`)
          })
      },
