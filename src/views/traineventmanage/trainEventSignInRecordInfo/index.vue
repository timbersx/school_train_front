<!--/*
 * @Name: TrainEventSignInRecordInfo
 * @Module:  src/views/traineventmanage/trainEventSignInRecordInfo/index
 * @Desc: TrainEventSignInRecordInfo
...
<template>
  <div class='app-container'>
      ...
      >
        ...
        >           <el-col :span='8'>
               <el-form-item
                   :label="$t('trainEventSignInRecordInfo.train_event')"
                   prop='train_event'
               >
                   <el-select
                       v-model='exactSearchData.train_event__name.type'
                   ...
                   >
                    <el-option
                        ...
                        :key="item.value"
                        :label="item.label"
                        :value="'train_event__name'+item.value"
                    >
                    </el-option>
                   </el-select>
                   <el-input
                      v-show="exactSearchData.train_event__name.type !='train_event__name__isnull' && exactSearchData.train_event__name.type !='train_event__name__notnull'"
                      v-model='exactSearchData.train_event__name.value'
           ...
           <el-col :span='8'>
               <el-form-item
                   :label="$t('trainEventSignInRecordInfo.teacher')"
                   prop='teacher'
               >
                   <el-select
                       v-model='exactSearchData.teacher__name.type'
                       :placeholder="$t('common.select')"
                       class='exactSearchSelect'
                       popper-class='exactSearchSelectZIndex'
                   >
                    <el-option
                        ...
                        :key="item.value"
                        :label="item.label"
                        :value="'teacher__name'+item.value"
                    >
                    </el-option>
                   </el-select>
                   <el-input
                      v-show="exactSearchData.teacher__name.type !='teacher__name__isnull' && exactSearchData.teacher__name.type !='teacher__name__notnull'"
                      v-model='exactSearchData.teacher__name.value'
                      class='exactSearchInput'
                      type='text'
                   ></el-input>
               </el-form-item>
           ...
           <el-col :span='8'>
               ...
               >
                   <el-select
                       v-model='exactSearchData.sign_in_time.type'
                       :placeholder="$t('common.select')"
                       class='exactSearchSelect'
                       popper-class='exactSearchSelectZIndex'
                   >
                    <el-option
                        ...
                        :key="item.value"
                        :label="item.label"
                        :value="'sign_in_time'+item.value"
                    >
                    </el-option>
                   </el-select>
                   <el-input
                      v-show="exactSearchData.sign_in_time.type !='sign_in_time__isnull' && exactSearchData.sign_in_time.type !='sign_in_time__notnull'"
                      v-model='exactSearchData.sign_in_time.value'
                      class='exactSearchInput'
                      type='text'
                   ></el-input>
               </el-form-item>
           ...
           <el-col :span='8'>
               <el-form-item
                   :label="$t('trainEventSignInRecordInfo.remark')"
                   prop='remark'
               >
                   <el-select
      ...
      >
          ...
          <el-table-column
              ...
              :key='index'
              :prop='item'
              :label="$t(`trainEventSignInRecordInfo.${item}`)"
           >
              <template slot-scope='scope'>
...
<script>
import { getTrainEventSignInRecordInfoList, deleteTrainEventSignInRecordInfo, exportTrainEventSignInRecordInfo } from '@/api/traineventmanage/trainEventSignInRecordInfo'
...
export default {
  ...
  data(){
      return{
          ...
          listColumns:['train_event','teacher','sign_in_time','remark'], //表中显示的列
          ...
          exactSearchData:{ //精确查找的model
              ...
              sign_in_time:{value:'',type:'',value_range:''},
  ...
  methods: {
      ...
      getListData() {
          ...
          getTrainEventSignInRecordInfoList(this.apiQueryData
      ...
      handleDeleteClick(row) {
          ...
          if (this.deleteRoute !=  {}) {
              ...
              .then(async () => {
                  deleteTrainEventSignInRecordInfo(row.id).then(response => {
      ...
      exportBtnClick(item) {
          ...
          exportTrainEventSignInRecordInfo(exportData).then(response=>{
              fileDownload(response,`${this.$t('route.trainEventSignInRecordInfo')}.xls`)
          })
      },
