<!--/*
 * @Name: statisticsSchoolbasedTraining
 * @Module:  src/views/traineventmanage/statisticsSchoolbasedTraining/index
 * @Desc: statisticsSchoolbasedTraining
  ...
  <div class="app-container">
    ...
    >
      ...
      >
        <el-col :span="8">
          <el-form-item
            :label="$t('statisticsSchoolbasedTraining.year')"
            prop="year"
          >
            <el-select
        ...
        <el-col :span="8">
          <el-form-item
            :label="$t('statisticsSchoolbasedTraining.school')"
            prop="school"
          >
            <el-select
        ...
        <el-col :span="8">
          <el-form-item
            :label="$t('statisticsSchoolbasedTraining.train_event')"
            prop="train_event"
          >
            <el-select
              v-model="exactSearchData.train_event.type"
              :placeholder="$t('common.select')"
              class="exactSearchSelect"
              popper-class="exactSearchSelectZIndex"
            >
              <el-option
                ...
                :key="item.value"
                :label="item.label"
                :value="'train_event' + item.value"
              >
              </el-option>
            </el-select>
            <el-input
              v-show="
                exactSearchData.train_event.type !=
                  'train_event__isnull' &&
                exactSearchData.train_event.type !=
                  'train_event__notnull'
              "
              v-model="exactSearchData.train_event.value"
              class="exactSearchInput"
              type="text"
            ></el-input>
          </el-form-item>
        ...
        <el-col :span="8">
          <el-form-item
            :label="$t('statisticsSchoolbasedTraining.budget')"
            prop="budget"
          >
            <el-select
              v-model="exactSearchData.budget.type"
              :placeholder="$t('common.select')"
              class="exactSearchSelect"
              popper-class="exactSearchSelectZIndex"
            >
              <el-option
                ...
                :key="item.value"
                :label="item.label"
                :value="'budget' + item.value"
              >
              </el-option>
            </el-select>
            <el-input
              v-show="
                exactSearchData.budget.type !=
                  'budget__isnull' &&
                exactSearchData.budget.type !=
                  'budget__notnull'
              "
              v-model="exactSearchData.budget.value"
              class="exactSearchInput"
              type="text"
            ></el-input>
          </el-form-item>
    ...
    >
      ...
      <el-table-column
        ...
        :key="index"
        :prop="item"
        :label="$t(`statisticsSchoolbasedTraining.${item}`)"
      >
        <template slot-scope="scope">
  ...
  data() {
    return {
      ...
      exactSearchData: {
        ...
        train_event: { value: "", type: "", value_range: "" },
        budget: { value: "", type: "", value_range: "" },
      },
      charFilter,
      intFilter,
      dateFilter,
