...
<template>
  <div v-loading="loading" class="app-container">
    <sticky :z-index="10" class-name="sub-navbar" style="margin-bottom: 20px">
      <el-button v-if="identity" type="primary" @click="handleUploadCheck">{{
      ...
      <el-main>
        ...
        <el-card shadow="never" style="margin: 0 20px 20px">
          ...
          >
            ...
            <template v-if="identity" v-slot:expertColumn>
          ...
          <el-form v-if="identity" ref="identityData" label-width="160px" label-suffix=":" :model="identityData" :rules="approveCommentRules">
            <el-row>
              <el-col :span="24">
...
} from '@/api/municipalPlan/municipalPlanExpertReview'
import EtEvaluationTable from '@/components/EtEvaluationTable'
import EtPlanDetail from '@/components/EtPlanCityDetail'
export default {
  components: {
    Sticky,
    EtEvaluationTable,
