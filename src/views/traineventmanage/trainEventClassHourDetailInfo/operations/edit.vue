<!--/*
 * @Name: TrainEventClassHourDetailInfo edit
 * @Module:  src/views/trainEventClassHourDetailInfo/operations/edit
 * @Desc: TrainEventClassHourDetailInfo edit
...
import { readTrainEventClassHourDetailInfo, updateTrainEventClassHourDetailInfo } from '@/api/traineventmanage/trainEventClassHourDetailInfo'
...
attachment_explain:[
  ...
  methods: {
      init(){
         ...
         ,readTrainEventClassHourDetailInfo(this.editId),
...
// this.attachment_Operations=response[1].data
             ...
             this.formData.class_hour = this.formData.class_hour==null?this.formData.class_hour:this.formData.class_hour.id
this.formData.attachment = this.formData.attachment==null?this.formData.attachment:this.formData.attachment.id
             this.loading = false
         })
      },
      handleSubmitForm() {
          this.$refs['dataForm'].validate(valid => {
              if (valid) {
                  this.loading = true
                  updateTrainEventClassHourDetailInfo(this.editId, this.formData).then(response => {
