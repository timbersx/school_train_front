    ...
    <el-container class="form-container">
      <el-main>
        ...
        <div style="margin-top: 20px; font-size: 14px" v-if="identity">
          ...
          <el-form v-if="identity" label-width="160px" label-suffix=":">
            <el-row>
              <el-col :span="24">
...
import { getPlanScorePoints, readAnnualTrainplanInfo, expertCheck, getUserExpertIdentity } from '@/api/municipalPlan/municipalPlanExpertReview'
...
export default {
  ...
  methods: {
    ...
    getTrainplanStatus(status) {
      if (status) {
        const getStatus = this.trainPlanCheckStatusList.find(item => item.code === status)
