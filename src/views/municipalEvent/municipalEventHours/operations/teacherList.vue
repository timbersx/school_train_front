...
import { getSchoolTrainEventClassHourInfoList, exportClassHourInfo } from '@/api/municipalEvent/municipalEventHours'
...
export default {
  ...
  methods: {
    ...
    handleRecognizeClick(row) {
      this.$router.push({
        path: '/municipalEvent/municipalEventHours/recognize',
