...
import { getSchoolTrainEventFundsRecordInfoList, deleteSchoolTrainEventFundsRecordInfo } from '@/api/municipalEvent/municipalEventFundsRecords'
...
export default {
  ...
  methods: {
    ...
    handleEditClick(row) {
      this.$router.push({
        path: '/municipalEvent/municipalEventFundsRecords/edit',
        query: { tId: row.id, pId: row.train_event.id }
      })
    },
    handleDetailClick(row) {
      this.$router.push({
        path: '/municipalEvent/municipalEventFundsRecords/detail',
        query: { tId: row.id, pId: row.train_event.id }
      })
    },
