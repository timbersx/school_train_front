...
<template>
  <div class='app-container'>
      ...
      >
        ...
        >           <el-col :span='8'>
               <el-form-item
                   :label="$t('trainEventCheckInfo.train_project')"
                   prop='train_project'
               >
                   <el-select
           ...
           <el-col :span='8'>
               <el-form-item
                   :label="$t('trainEventCheckInfo.result')"
                   prop='result'
               >
                   <el-select
           ...
           <el-col :span='8'>
               <el-form-item
                   :label="$t('trainEventCheckInfo.check_user')"
                   prop='check_user'
               >
                   <el-select
           ...
           <el-col :span='8'>
               <el-form-item
                   :label="$t('trainEventCheckInfo.check_time')"
                   prop='check_time'
               >
                   <el-select
           ...
           <el-col :span='8'>
               <el-form-item
                   :label="$t('trainEventCheckInfo.remark')"
                   prop='remark'
               >
                   <el-select
...
<script>
import { getTrainEventCheckInfoList, deleteTrainEventCheckInfo, exportTrainEventCheckInfo } from '@/api/traineventmanage/trainEventCheckInfo'
...
export default {
  ...
  data(){
      return{
          ...
          listColumns:['train_project','result','check_user','check_time','remark'], //表中显示的列
  ...
  methods: {
      ...
      getListData() {
          ...
          getTrainEventCheckInfoList(this.apiQueryData
