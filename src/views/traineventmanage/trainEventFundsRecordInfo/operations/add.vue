<!--/*
 * @Name: TrainEventFundsRecordInfo add
 * @Module:  src/views/trainEventFundsRecordInfo/operations/edit
 * @Desc: TrainEventFundsRecordInfo add
        ...
        >
          ...
          <el-col :span="12">
            <el-form-item :label="$t('trainEventFundsRecordInfo.attachments')" prop="attachments">
              <et-upload-item v-model="formData.attachments" accept-type=".doc, .docx, .xls, .xlsx, .pdf" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item :label="$t('trainEventFundsRecordInfo.funds_explain')" prop="funds_explain">
              <el-input v-model="formData.funds_explain" :rows="10" class="col-items" type="textarea" clearable :placeholder="$t('table.input')" />
            </el-form-item>
          </el-col>
        </el-form>
      </el-main>
...
import { createSchoolTrainEventFundsRecordInfo } from '@/api/traineventmanage/trainEventFundsRecordInfo'
  ...
  methods: {
    start() {
      ...
      Promise.all([
        ...
        this.$set(this.formData, 'funds', '0.00')
    ...
    handleSubmitForm() {
      this.$refs['dataForm'].validate(valid => {
        if (valid) {
          ...
          createSchoolTrainEventFundsRecordInfo(submitData).then(response => {
