...
<script>
import { getScorePointInfo, delScorePointInfo } from '@/api/municipalPlan/annualPlanReviewStandard'
import { readIndicatorinfo } from '@/api/municipalPlan/annualPlanReviewIndicators'
import EtStandardEvaluateTree from '@/components/EtStandardCityTree'
