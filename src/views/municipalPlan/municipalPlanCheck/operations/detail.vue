            ...
            <el-row v-if="trainplanData.plan_type.code !== 'CGPX'">
              <el-col :span="8">
                ...
                >
                  <span>
                    {{
                      trainplanData.funds_education
                        ? trainplanData.funds_education.funds
                        : ""
                    }}
                  </span>
                </el-form-item>
            ...
            <el-row>
              <el-col :span="24">
                ...
                >
                  <span>{{
                    trainplanData.funds_education
                      ? trainplanData.funds_education.approve_comment
                      : ""
                  }}</span>
                </el-form-item>
              </el-col>
...
export default {
  ...
  data() {
    return {
      ...
      trainplanData: {
        funds: '',
        status: '',
        funds_education: { funds: '', approve_comment: '' },
        plan_type: { code: '' }
      },
      listLoading: false,
      listColumnsCGPX: [
  ...
  methods: {
    ...
    getTrainplanStatus(status) {
      if (status) {
        const getStatus = this.trainPlanCheckStatusList.find(
