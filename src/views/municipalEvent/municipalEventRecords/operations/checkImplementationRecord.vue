...
import { getSchoolTrainEventImplementationRecordInfoList, deleteSchoolTrainEventImplementationRecordInfo } from '@/api/municipalEvent/municipalEventRecords'
...
export default {
  ...
  methods: {
    ...
    handleEditClick(row) {
      this.$router.push({
        path: '/municipalEvent/municipalEventRecords/edit',
        query: { tId: row.id, pId: row.train_event.id }
      })
    },
    handleDetailClick(row) {
      this.$router.push({
        path: '/municipalEvent/municipalEventRecords/detail',
        query: { tId: row.id, pId: row.train_event.id }
      })
    },
