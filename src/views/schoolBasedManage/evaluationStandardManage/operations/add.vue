        ...
        <el-row>
          <el-col :span="22">
            <el-form-item :label="$t('evaluationStandardManage.max_score')" prop="max_score">
              <el-input type="number" v-model="form.max_score" :placeholder="$t('table.input')" />
            </el-form-item>
          </el-col>
        </el-row>
        <!-- 排序 -->
        <el-row>
          <el-col :span="22">
            <el-form-item :label="$t('evaluationStandardManage.order_no')" prop="order_no">
              <el-input type="number" v-model.number="form.order_no" :placeholder="$t('table.input')" />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
...
<script>
import { addScorePointInfo } from '@/api/schoolBasedManage/evaluationStandardManage'
