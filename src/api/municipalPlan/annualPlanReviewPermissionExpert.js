...
export function getExpertGroupList(params) {
  return request({
    url: '/areatraining/expertgroupinfo/list_with_combination/',
    method: 'get',
    params
  })
}
...
export function getIndicatorScoreTreeData(params) {
  return request({
    url: '/areatraining/evaluatepermission/get_indicator_score_points/',
    method: 'get',
    params
  })
}
...
export function getExpertPermission(params) {
  return request({
    url: '/areatraining/evaluatepermission/get_expert_permission/',
    method: 'get',
    params
  })
}
...
export function setExpertPermission(data) {
  return request({
    url: '/areatraining/evaluatepermission/set_expert_permission/',
    method: 'post',
    data
  })
}
