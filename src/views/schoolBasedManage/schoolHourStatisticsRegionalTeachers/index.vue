<!--/*
 * @Name: schoolHourStatisticsRegionalTeachers
 * @Module:  src/views/traineventmanage/schoolHourStatisticsRegionalTeachers/index
 * @Desc: schoolHourStatisticsRegionalTeachers
  ...
  <div class="app-container">
    ...
    >
      ...
      >
        <el-col :span="8">
          <el-form-item
            :label="$t('schoolHourStatisticsRegionalTeachers.year')"
            prop="year"
          >
            <el-select
        ...
        <el-col :span="8">
          <el-form-item
            :label="$t('schoolHourStatisticsRegionalTeachers.school')"
            prop="school"
          >
            <el-select
        ...
        <el-col :span="8">
          <el-form-item
            :label="$t('schoolHourStatisticsRegionalTeachers.teacher')"
            prop="teacher"
          >
            <el-select
              v-model="exactSearchData.teacher.type"
              :placeholder="$t('common.select')"
              class="exactSearchSelect"
              popper-class="exactSearchSelectZIndex"
            >
              <el-option
                ...
                :key="item.value"
                :label="item.label"
                :value="'teacher' + item.value"
              >
              </el-option>
            </el-select>
            <el-input
              v-show="
                exactSearchData.teacher.type != 'teacher__isnull' &&
                exactSearchData.teacher.type != 'teacher__notnull'
              "
              v-model="exactSearchData.teacher.value"
              class="exactSearchInput"
              type="text"
            ></el-input>
          </el-form-item>
        ...
        <el-col :span="8">
          <el-form-item
            :label="$t('schoolHourStatisticsRegionalTeachers.train_hour')"
            prop="train_hour"
          >
            <el-select
              v-model="exactSearchData.train_hour.type"
              :placeholder="$t('common.select')"
              class="exactSearchSelect"
              popper-class="exactSearchSelectZIndex"
            >
              <el-option
                ...
                :key="item.value"
                :label="item.label"
                :value="'train_hour' + item.value"
              >
              </el-option>
            </el-select>
            <el-input
              v-show="
                exactSearchData.train_hour.type != 'train_hour__isnull' &&
                exactSearchData.train_hour.type != 'train_hour__notnull'
              "
              v-model="exactSearchData.train_hour.value"
              class="exactSearchInput"
              type="text"
            ></el-input>
          </el-form-item>
    ...
    >
      ...
      <el-table-column
        ...
        :key="index"
        :prop="item"
        :label="$t(`schoolHourStatisticsRegionalTeachers.${item}`)"
      >
        <template slot-scope="scope">
  ...
  data() {
    return {
      ...
      exactSearchData: {
        ...
        teacher: { value: "", type: "", value_range: "" },
        train_hour: { value: "", type: "", value_range: "" },
      },
      charFilter,
      intFilter,
      dateFilter,
